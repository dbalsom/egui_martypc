...
/// Installs a hook that receives raw browser keyboard events before eframe translates them.
#[cfg(target_arch = "wasm32")]
pub use crate::web::install_keyboard_event_hook;

/// Raw browser keyboard event data forwarded by [`install_keyboard_event_hook`].
#[cfg(target_arch = "wasm32")]
#[derive(Clone, Debug)]
pub struct WebKeyboardEvent {
    /// The browser [`KeyboardEvent.code`](https://developer.mozilla.org/en-US/docs/Web/API/KeyboardEvent/code).
    pub key: String,
